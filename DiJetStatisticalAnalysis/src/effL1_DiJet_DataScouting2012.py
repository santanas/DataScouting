...
File1 = GetFile("SingleMu_V00-01-06_Run2012B_random10percent_5Mevents_forL1DijetStudiesInDataScouting.root")
## NEED TO UNDERSTAND HOW TO READ DIRECTLY FROM EOS IN PYROOT


#--------- Muons ----------
outputFile = "effL1.png"

h_Mjj_den_NOdeta = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_denL1_NOdeta" , File1)
h_Mjj_num_NOdeta = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_numL1_NOdeta" , File1)

h_Mjj_den_detaL4 = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_denL1_detaL4" , File1)
h_Mjj_num_detaL4 = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_numL1_detaL4" , File1)

h_Mjj_den_detaL3 = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_denL1_detaL3" , File1)
h_Mjj_num_detaL3 = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_numL1_detaL3" , File1)

h_Mjj_den_detaL2 = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_denL1_detaL2" , File1)
h_Mjj_num_detaL2 = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_numL1_detaL2" , File1)

h_Mjj_den = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_denL1" , File1)
h_Mjj_num = GetHisto( "DQMData/Run 999999/DataScouting/Run summary/DiJet/h1_MjjWide_numL1" , File1)
...
eff_L1seed_wrt_HLTIsoMu24AndMu40_NOdeta = GetEffFixBinning( h_Mjj_num_NOdeta , h_Mjj_den_NOdeta
                                                            , 0.9 , 20 , 6
                                                            , "M_{jj} WideJets [GeV]" , "L1 Efficiency wrt HLT_IsoMu24 OR HLT_Mu40"
                                                            , 0, 2000,  0, 1.1)
#--- Calculate L1 Efficiency wrt HLT IsoMu24 OR Mu40
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL4 = GetEffFixBinning( h_Mjj_num_detaL4 , h_Mjj_den_detaL4
                                                            , 0.9 , 20 , 4
                                                            , "M_{jj} WideJets [GeV]" , "L1 Efficiency wrt HLT_IsoMu24 OR HLT_Mu40"
                                                            , 0, 2000,  0, 1.1)
#--- Calculate L1 Efficiency wrt HLT IsoMu24 OR Mu40
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL3 = GetEffFixBinning( h_Mjj_num_detaL3 , h_Mjj_den_detaL3
                                                            , 0.9 , 20 , 3
                                                            , "M_{jj} WideJets [GeV]" , "L1 Efficiency wrt HLT_IsoMu24 OR HLT_Mu40"
                                                            , 0, 2000,  0, 1.1)
#--- Calculate L1 Efficiency wrt HLT IsoMu24 OR Mu40
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL2 = GetEffFixBinning( h_Mjj_num_detaL2 , h_Mjj_den_detaL2
                                                            , 0.9 , 20 , 2
                                                            , "M_{jj} WideJets [GeV]" , "L1 Efficiency wrt HLT_IsoMu24 OR HLT_Mu40"
                                                            , 0, 2000,  0, 1.1)
#--- Calculate L1 Efficiency wrt HLT IsoMu24 OR Mu40
eff_L1seed_wrt_HLTIsoMu24AndMu40 = GetEffFixBinning( h_Mjj_num , h_Mjj_den
                                                     , 0.9 , 20 , 1
                                                     , "M_{jj} WideJets [GeV]" , "L1 Efficiency wrt HLT_IsoMu24 OR HLT_Mu40"
                                                     , 0, 2000,  0, 1.1)
...
c1.SetGridy();
c1.SetGridx();
eff_L1seed_wrt_HLTIsoMu24AndMu40_NOdeta.Draw("ap")
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL4.Draw("samep")
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL3.Draw("samep")
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL2.Draw("samep")
eff_L1seed_wrt_HLTIsoMu24AndMu40.Draw("samep")

#---Create legend
globals()['legend1'] = TLegend(0.534483,0.184322,0.840517,0.375)
legend1.SetFillColor(kWhite)
legend1.SetMargin(0.2)
legend1.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40_NOdeta,"L1 DataScouting (no deta cut)","p")
legend1.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL4,"L1 DataScouting (deta < 4.0)","p")
legend1.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL3,"L1 DataScouting (deta < 3.0)","p")
legend1.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL2,"L1 DataScouting (deta < 2.0)","p")
legend1.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40,"L1 DataScouting (deta < 1.3)","p")
legend1.Draw()
c1.Update()
gPad.RedrawAxis()
gPad.Modified()
...
c2.SetGridy();
c2.SetGridx();
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL4.Draw("ap")

#---Create legend
globals()['legend2'] = TLegend(0.534483,0.184322,0.840517,0.375)
legend2.SetFillColor(kWhite)
legend2.SetMargin(0.2)
legend2.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL4,"HLT DataScouting","p")
legend2.Draw()
c2.Update()
gPad.RedrawAxis()
gPad.Modified()
...
c3.SetGridy();
c3.SetGridx();
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL3.Draw("ap")

#---Create legend
globals()['legend3'] = TLegend(0.534483,0.184322,0.840517,0.375)
legend3.SetFillColor(kWhite)
legend3.SetMargin(0.2)
legend3.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL3,"HLT DataScouting","p")
legend3.Draw()
c3.Update()
gPad.RedrawAxis()
gPad.Modified()
...
c4.SetGridy();
c4.SetGridx();
eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL2.Draw("ap")

#---Create legend
globals()['legend4'] = TLegend(0.534483,0.184322,0.840517,0.375)
legend4.SetFillColor(kWhite)
legend4.SetMargin(0.2)
legend4.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40_detaL2,"HLT DataScouting","p")
legend4.Draw()
c4.Update()
gPad.RedrawAxis()
gPad.Modified()
...
c5.SetGridy();
c5.SetGridx();
eff_L1seed_wrt_HLTIsoMu24AndMu40.Draw("ap")

#---Create legend
globals()['legend5'] = TLegend(0.534483,0.184322,0.840517,0.375)
legend5.SetFillColor(kWhite)
legend5.SetMargin(0.2)
legend5.AddEntry(eff_L1seed_wrt_HLTIsoMu24AndMu40,"HLT DataScouting","p")
legend5.Draw()
c5.Update()
gPad.RedrawAxis()
gPad.Modified()
